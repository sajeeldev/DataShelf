            ...
            <main class="flex-1 overflow-y-auto p-8">
                ...
                <div class="bg-white rounded-xl shadow-md p-8 mb-8">
                    ...
                    <form action="{{ route('upload.csvfile') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div
                            class="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center hover:border-blue-500 transition duration-200 cursor-pointer relative">
                            <input type="file" name="csvfile" id="fileInput" accept=".csv"
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-700 mb-2">Drop your file here or click to
                                    browse</h3>
                ...
                {{-- <div class="bg-white rounded-xl shadow-md p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            <div class="text-right">
                                <span
                                    class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">Interview</span>
                        ...
                        <div
                            ...
                            <div class="text-right">
                                <span
                                    class="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Offer</span>
